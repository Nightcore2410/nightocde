    ...
    <Container>
      ...
      <Col lg='2'>
        ...
        <div className="hero__content">
            ...
            <h1>Núi Bà Đen huyền thoại {" "}
            <span className="highlight"></span>
            </h1>
            <p>
            Hàng năm, cứ đến ngày 14 tháng giêng âm lịch, 
            Huyện ủy Hòa Thành đều tổ chức trọng thể lễ họp mặt 
            truyền thống Động Kim Quang để tưởng niệm những người đã
             hy sinh vì sự nghiệp giải phóng dân tộc. Những người đến đây,
              cả thế hệ ngày trước và ngày nay đã dành phút giây tưởng niệm 
              để vẳng nghe tiếng vọng của hồn thiêng sông núi, kính cẩn nghiêng
               mình trước vong linh của những người đã mất từ Động Kim Quang để 
